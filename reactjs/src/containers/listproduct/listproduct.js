  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const response = await axios.get('http://localhost:3000/api/v1/listproduct', { params });
    ...
    fetchProducts();
  }, [categoryId, brandId, keyword, currentPage, filterMinPrice, filterMaxPrice, sortOption]);
